...
public class CircleViewByImage extends FrameLayout {
    ...
    public CircleViewByImage(Context context, AttributeSet attrs) {
        ...
        mBackgroundId = array.getResourceId(R.styleable.CircleViewByImage_background, R.drawable.ic_yk_bg);
        foregroundId = array.getResourceId(R.styleable.CircleViewByImage_foreground, R.drawable.ic_hd_bg);
        array.recycle();
